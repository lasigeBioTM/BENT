...
ENTITY_STR = "ENTITY\ttext:{0}\tnormalName:{1}\tpredictedType:{2}\tq:true"
ENTITY_STR += "\tqid:Q{3}\tdocId:{4}\torigText:{0}\turl:{5}\n"
CANDIDATE_STR = "CANDIDATE\tid:{0}\tinCount:{1}\toutCount:{2}\tlinks:{3}\t"
CANDIDATE_STR += "url:{4}\tname:{5}\tnormalName:{6}\tnormalWikiTitle:{7}\t\
    predictedType:{8}\n"
